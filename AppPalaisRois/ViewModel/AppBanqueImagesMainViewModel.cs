...
{
    public class AppBanqueImagesMainViewModel : ViewModelBase
    {
        ...
        public AppBanqueImagesMainViewModel()
        {
            this._maps = FindMaps();
        }
        ...
        ~AppBanqueImagesMainViewModel()
        {
            DAOBanqueImages.Instance.Dispose();
        ...
        {
            List<Map> maps = new List<Map>(DAOBanqueImages.Instance.Maps);
