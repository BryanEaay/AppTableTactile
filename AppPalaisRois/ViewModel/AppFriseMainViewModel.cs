...
{
    public class AppFriseMainViewModel : ViewModelBase
    {
        ...
        ~AppFriseMainViewModel()
        {
            DAOFrise.Instance.Dispose();
        ...
        {
            List<Map> maps = new List<Map>(DAOFrise.Instance.Maps);
