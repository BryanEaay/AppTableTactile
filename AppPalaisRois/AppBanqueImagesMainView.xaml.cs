...
namespace AppPalaisRois
{
    public partial class AppBanqueImagesMainView : Window
    {
        ...
        public AppBanqueImagesMainView()
        {
            ...
            returnBanqueImages.Source = ResourceAccessor.loadImage("/CommonSurface;component/Resources/return.png");
            ...
            if (flowCarte.Items.Count < 2)
            {
                ...
                //imageFond.Width = 1920;
                //imageFond.Height = 1080;
                //flowCarte.ElementWidth = 1920;
                //flowCarte.ElementHeight = 1080;
            }
        }
