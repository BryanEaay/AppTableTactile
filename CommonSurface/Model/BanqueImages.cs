...
{
    [Serializable]
    public class BanqueImages : INotifyPropertyChanged
    {
        ...
        public BanqueImages(int id, string chemin, string nom, int gameId)
        {
            this.Id = id;
            this.Chemin = chemin;
            this.Nom = nom;
        ...
        public BanqueImages(int id, string chemin, string nom)
        {
            this.Id = id;
            this.Chemin = chemin;
            this.Nom = nom;
        ...
        public BanqueImages(Carte other)
        {
            Id = other.Id;
            GameId = other.GameId;
            Chemin = other.Chemin;
