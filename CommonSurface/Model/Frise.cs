...
{
    [Serializable]
    public class Frise : INotifyPropertyChanged
    {
        ...
        public Frise(int id, string chemin, string nom, int gameId)
        {
            this.Id = id;
            this.Chemin = chemin;
            this.Nom = nom;
        ...
        public Frise(int id, string chemin, string nom)
        {
            this.Id = id;
            this.Chemin = chemin;
            this.Nom = nom;
